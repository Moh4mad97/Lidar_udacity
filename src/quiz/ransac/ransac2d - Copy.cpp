...
std::unordered_set<int> Ransac_3d(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceTol)
{
    std::unordered_set<int> inliersResult;
    srand(time(NULL));
    int cloud_points = cloud->size();
...
int main ()
{
    ...
    std::unordered_set<int> inliers = Ransac_3d(cloud, 500, 0.4);
